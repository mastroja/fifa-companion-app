...
contextBridge.exposeInMainWorld('api', {
  ...
  getPlaystyleSuggestions: (playerId) => ipcRenderer.invoke('get-playstyle-suggestions', playerId),
  getPendingPlaystyleAlerts: () => ipcRenderer.invoke('get-pending-playstyle-alerts'),
  getPlaystyleRules: () => ipcRenderer.invoke('get-playstyle-rules'),
